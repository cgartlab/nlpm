...
Canonical noun and verb registry across NLPM's two scopes (internal and auditor), plus the bright-line evaluation cluster and the deferred-vs-rejected split per the P6 precedence order.

## How this registry is built {#vocab-how-this-registry-is-built}
...
## Two scopes (P1) {#vocab-two-scopes-p1}
...
## The bright-line table (P1, P5) {#vocab-the-bright-line-table-p1-p5}
...
## How to extend this registry {#vocab-how-to-extend-this-registry}
...
## Deferred work (documented, not yet executed) {#vocab-deferred-work-documented-not-yet-executed}
...
## Auditor workflow filename convention {#vocab-auditor-workflow-filename-convention}
