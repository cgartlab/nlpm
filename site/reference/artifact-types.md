...
Every NL programming artifact NLPM scores. Each row in a report's *type* column maps to one section below.
...
## Command Frontmatter {#artifact-command-frontmatter}
...
## Shared Partials {#artifact-shared-partials}
...
## Agent Frontmatter {#artifact-agent-frontmatter}
...
## Skill Structure {#artifact-skill-structure}
...
## Hook Events {#artifact-hook-events}
...
## hooks.json Format {#artifact-hooks-json-format}
...
## General Prompt Engineering {#artifact-general-prompt-engineering}
...
## Naming Conventions {#artifact-naming-conventions}
...
## Reference Syntax {#artifact-reference-syntax}
...
## Memory File Conventions {#artifact-memory-file-conventions}
...
## Rule Overrides in nlpm.local.md {#artifact-rule-overrides-in-nlpm-local-md}
...
## Claude Code Tool Catalog {#artifact-claude-code-tool-catalog}
